        ...
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex gap-1">
            <button
              ...
              className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-full border border-white/30 opacity-90 hover:opacity-100 hover:bg-white/10 transition-all"
            >
            ...
            <button
              ...
              disabled={deleting}
              className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-full border border-white/30 opacity-90 hover:opacity-100 hover:bg-red-500/20 transition-all disabled:opacity-50"
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
