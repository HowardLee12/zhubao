    ...
    >
      ...
      {trade.isConflict ? (
        ...
        <select
          ...
          className={`text-[11px] font-semibold shrink-0 pl-2 pr-5 py-1 rounded-full border appearance-none cursor-pointer transition-all ${statusSelectStyle[optimisticStatus]}`}
          style={{
